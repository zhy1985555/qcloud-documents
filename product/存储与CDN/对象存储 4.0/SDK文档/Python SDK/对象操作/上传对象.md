...
|Key | 对象键（Key）是对象在存储桶中的唯一标识。例如，在对象的访问域名 `examplebucket-1250000000.cos-internal.ap-guangzhou.tencentcos.cn/doc/pic.jpg` 中，对象键为 doc/pic.jpg|String|
...
```python
{
    ...
    'Bucket': 'examplebucket-1250000000', 
    'Location': 'examplebucket-1250000000.cos-internal.ap-guangzhou.tencentcos.cn/exampleobject', 
    'Key': 'exampleobject'
}
```
